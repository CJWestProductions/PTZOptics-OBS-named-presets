...
let copyUpdateExe = (() => {
  var ref = (0, _bluebird.coroutine)(function* (desitination, options, rcEditOptions, baseSignOptions) {
    ...
    yield signFile(desitination, baseSignOptions);
  });
...
let build = (() => {
  var ref = (0, _bluebird.coroutine)(function* (options, stageDir) {
    ...
    if (options.msi && process.platform === 'win32') {
      ...
      yield signFile(_path2.default.join(outputDirectory, outFile), baseSignOptions);
    }
  });
...
<coreProperties xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  return function pack(_x10, _x11, _x12, _x13, _x14, _x15) {
    return ref.apply(this, arguments);
  };
})();
...
let releasify = (() => {
  ...
  return function releasify(_x16, _x17, _x18) {
    return ref.apply(this, arguments);
  };
})();
...
let msi = (() => {
  ...
  return function msi(_x19, _x20, _x21, _x22) {
    return ref.apply(this, arguments);
  };
})();

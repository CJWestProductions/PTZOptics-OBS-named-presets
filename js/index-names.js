...
var config = defaults;
var configStore = document.head.querySelector("[name~=config][content]").content;
config.ip = camera_ip;

function get_config () {
	var result = localStorage.getItem(configStore);
  if (!result) {
    return config;
  } else {
...
function save_config () {
	localStorage.setItem(configStore, JSON.stringify(config));
	console.log(config);
}
...
function reload_cam () {
	...
	if (/^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.test(config.ip)) {
		...
		IDtext('IP-saved', "<br>New IP Address saved successfully!");

	} else {

		IDtext('IP-saved', "IP address (" + config.ip + ") entered is invalid! Re-enter camera IP address.");
	}

	setTimeout(IDtext, 1500, 'IP-saved', "<br><br>");
}
...
function name_preset (preset, name_holder) {
    if (name_holder !== "") {
		switch (preset) {

			case '1':

				document.getElementById('name1').innerHTML = name_holder;
				config.preset_name_1 = name_holder;
				if (name_holder === defaults.preset_name_1) {
					document.getElementById('name1').style.fontSize = "50px";
					document.getElementById('name1').style.lineHeight = "75px";
				} else {
					document.getElementById('name1').style.fontSize = "20px";
					document.getElementById('name1').style.lineHeight = "25px";
				}
				break;

			case '2':

				document.getElementById('name2').innerHTML = name_holder;
				config.preset_name_2 = name_holder;
				if (name_holder === defaults.preset_name_2) {
					document.getElementById('name2').style.fontSize = "50px";
					document.getElementById('name2').style.lineHeight = "75px";
				} else {
					document.getElementById('name2').style.fontSize = "20px";
					document.getElementById('name2').style.lineHeight = "25px";
				}
				break;

			case '3':

				document.getElementById('name3').innerHTML = name_holder;
				config.preset_name_3 = name_holder;
				if (name_holder === defaults.preset_name_3) {
					document.getElementById('name3').style.fontSize = "50px";
					document.getElementById('name3').style.lineHeight = "75px";
				} else {
					document.getElementById('name3').style.fontSize = "20px";
					document.getElementById('name3').style.lineHeight = "25px";
				}
				break;

			case '4':

				document.getElementById('name4').innerHTML = name_holder;
				config.preset_name_4 = name_holder;
				if (name_holder === defaults.preset_name_4) {
					document.getElementById('name4').style.fontSize = "50px";
					document.getElementById('name4').style.lineHeight = "80px";
				} else {
					document.getElementById('name4').style.fontSize = "20px";
					document.getElementById('name4').style.lineHeight = "25px";
				}
				break;

			case '5':

				document.getElementById('name5').innerHTML = name_holder;
				config.preset_name_5 = name_holder;
				if (name_holder === defaults.preset_name_5) {
					document.getElementById('name5').style.fontSize = "50px";
					document.getElementById('name5').style.lineHeight = "80px";
				} else {
					document.getElementById('name5').style.fontSize = "20px";
					document.getElementById('name5').style.lineHeight = "25px";
				}
				break;

			case '6':

				document.getElementById('name6').innerHTML = name_holder;
				config.preset_name_6 = name_holder;
				if (name_holder === defaults.preset_name_6) {
					document.getElementById('name6').style.fontSize = "50px";
					document.getElementById('name6').style.lineHeight = "80px";
				} else {
					document.getElementById('name6').style.fontSize = "20px";
					document.getElementById('name6').style.lineHeight = "25px";
				}
				break;

			case '7':

				document.getElementById('name7').innerHTML = name_holder;
				config.preset_name_7 = name_holder;
				if (name_holder === defaults.preset_name_7) {
					document.getElementById('name7').style.fontSize = "50px";
					document.getElementById('name7').style.lineHeight = "80px";
				} else {
					document.getElementById('name7').style.fontSize = "20px";
					document.getElementById('name7').style.lineHeight = "25px";
				}
				break;

			case '8':

				document.getElementById('name8').innerHTML = name_holder;
				config.preset_name_8 = name_holder;
				if (name_holder === defaults.preset_name_8) {
					document.getElementById('name8').style.fontSize = "50px";
					document.getElementById('name8').style.lineHeight = "80px";
				} else {
					document.getElementById('name8').style.fontSize = "20px";
					document.getElementById('name8').style.lineHeight = "25px";
				}
				break;

			case '9':

				document.getElementById('name9').innerHTML = name_holder;
				config.preset_name_9 = name_holder;
				if (name_holder === defaults.preset_name_9) {
					document.getElementById('name9').style.fontSize = "50px";
					document.getElementById('name9').style.lineHeight = "80px";
				} else {
					document.getElementById('name9').style.fontSize = "20px";
					document.getElementById('name9').style.lineHeight = "25px";
				}
				break;
		}
	}
...
function clear_active_preset () {
	$('.call_preset').removeClass("active");
}
...
$('body').on('click', '.assign_preset', function(e) {
	...
	var name_holder = document.getElementById('preset_name').value;
	name_preset(preset, name_holder);
	document.getElementById('preset_name').value = "";
	if (preset == 11) {
		IDtext('presetSaved', `Auto Pan Left Start Position saved successfully!`);
	} else {
		IDtext('presetSaved', `Preset ${preset} saved successfully!`);
	}
	setTimeout(IDtext, 1500, 'presetSaved', "<br>");
	return false;
});
